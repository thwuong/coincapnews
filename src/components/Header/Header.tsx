...
function Header({ lang }: HeaderProps) {
  ...
  const handleSearch = async (searchTerms: string) => {
    const result = await fetchAPI(`/search?query=${searchTerms}`);
                ...
                {!loading && searchList && show && keyword && (
                  ...
                  >
                    <div className="flex flex-col gap-2">
                      <h3 className="font-semibold text-12 text-typo-4/80">
                        Coins
                      </h3>
                          ...
                          searchList.exchanges
                            ...
                            .map((exchange, index) => {
                              ...
                              return (
                                <div
                                  onClick={() =>
                                    nextPage(`/exchanges/${exchange.id}`)
                                  }
                                  key={key}

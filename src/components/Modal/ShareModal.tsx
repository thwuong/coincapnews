          ...
          <div className="flex flex-col items-center justify-center gap-6 pt-16 pb-4">
            ...
            <div className="flex flex-col gap-4 text-center">
              ...
              <p className="text-typo-1">
                The price of{" "}
                <span className="uppercase  font-bold">{symbol}</span> is{" "}
                <span className="text-primary-1">
                  {formatCurrency(
                    getNewData(newData?.price, oldData),
                    currentCurrency,
                    currentLanguage,
                    {
                ...
                >
                  <div className="flex items-center gap-1.5">
                    <Image
                      ...
                      height={18}
                    />
                    <span className="text-12 text-white uppercase font-bold">
                      COPY
                    </span>
                  </div>
                </Button>

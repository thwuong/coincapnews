...
export async function generateMetadata({ params }: PageProps, parent: ResolvingMetadata): Promise<Metadata> {
    ...
    // fetch data
    const content = await getPayloadContent("https://content-cms.onrender.com/api/pages/4", lang);
    ...
    return {
        ...
        openGraph: {
            ...
            title: content.meta?.title || title || "",
            description: content.meta?.description || description || "",
            url: `${WEBSITE_HOST_URL}/${lang}/terms-of-use`,
            locale: "en-US",
            siteName: content.meta?.title,
            type: "website",
        },
        alternates: {
            canonical: `${WEBSITE_HOST_URL}/${lang}/terms-of-use`,
        },
        twitter: {
    ...
    return (
        <main className="pb-24">
            <Container className="px-12">
                <Markdown url="https://content-cms.onrender.com/api/pages/4" />
            </Container>
        </main>
    );
}
